...
Característica: Obtener libros populares
  ...
  @autor
  Escenario: Busca los libros mas populares habiendo 5 libros
      ...
      Cuando solicite los libros mas populares
      ...
      Y obtiene el siguiente mensaje 'Estos son los 5 libros con mejor puntuación.'


  @autor
  Escenario: Busca los libros mas populares habiendo 0 libros
      Dado el conjunto de libros
      | NOMBRE                   | AUTOR         | ISBN          | RATING | CATEGORIA | IDIOMA  |
      Cuando solicite los libros mas populares
      ...
      Y son estos
      | LIBROS                   |
      Y obtiene el siguiente mensaje 'No existen libros a mostrar.'

  @autor
  Escenario: Busca los libros mas populares habiendo 3 libros
      Dada el conjunto de libros
      | NOMBRE                   | AUTOR         | ISBN          | RATING | CATEGORIA | IDIOMA  |
      | Persona Normal           | Benito Taibo  | 9786070715082 | 4.49   | jóvenes   | español |
      | Corazonadas              | Benito Taibo  | 9786070736315 | 4.49   | jóvenes   | español |
      | The Lies of Locke Lamora | Scott Lynch   | 9780553588941 | 4.30   | fantasía  | inglés  |
      Cuando solicite los libros mas populares
      Entonces obtendra 3 libros de resultado
      Y son estos
      | LIBROS                   |
      | Persona Normal           |
      | Corazonadas              |
      | The Lies of Locke Lamora |
      Y obtiene el siguiente mensaje 'Estos son los 3 libros con mejor puntuación.'