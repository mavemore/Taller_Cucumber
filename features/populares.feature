...
Característica: Obtener libros más populares
  ...
  Antecedentes:
    ...
    Escenario: Existen más de 5 libros en el top
        Cuando el usuario busque los libros más populares entre 5 o más
        ...
        Y obtiene el mensaje 1 'Estos son los 5 libros con mejor puntuación.'
    ...
    Escenario: Existen menos de 5 libros en el top
        ...
        | The Lies of Locke Lamora |
        | It                       |
        Y obtiene el mensaje 2 'Estos son los 4 libros con mejor puntuación.'

    Escenario: No Existen libros en el top
        Cuando el usuario busque los libros más populares
